...
//        callbacksById[call.arguments["id"]](call.arguments["args"]);
  ...
  Future<CancelListening> _startListening(
      Tuple4<ErrorCallback, ProgressCallback, DoneCallback, CancelCallback> callback,
  ...
  Future<CancelListening> startUploadTesting(
    ...
    return await _startListening(
        Tuple4(onError, onProgress, onDone, onCancel), CallbacksEnum.startUploadTesting, testServer,
        fileSize: fileSize);
  }
