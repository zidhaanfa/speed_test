import 'package:speed_test/src/speed_test_utils.dart';
import 'package:speed_test/src/test_result.dart';
...
class SpeedTest {
  ...
  static final SpeedTest _instance = SpeedTest._private();

  bool _isTestInProgress = false;
  bool _isCancelled = false;

  factory SpeedTest() => _instance;
  ...
  Future<void> startTesting({
    ...
    if ((downloadTestServer == null || uploadTestServer == null) && useFastApi) {
      ...
      final serverSelectionResponse = await SpeedTestPlatform.instance.getDefaultServer();
    ...
    SpeedTestPlatform.instance.startDownloadTesting(
      onDone: (double transferRate, SpeedUnit unit) {
        ...
        SpeedTestPlatform.instance.startUploadTesting(
          onDone: (double transferRate, SpeedUnit unit) {
  ...
  void enableLog() {
    SpeedTestPlatform.instance.toggleLog(value: true);
  }

  void disableLog() {
    SpeedTestPlatform.instance.toggleLog(value: false);
  }

  Future<bool> cancelTest() async {
    _isCancelled = true;
    return await SpeedTestPlatform.instance.cancelTest();
  }

  bool get isLogEnabled => SpeedTestPlatform.instance.logEnabled;
}
